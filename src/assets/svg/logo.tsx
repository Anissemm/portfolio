...
const Logo = forwardRef<SVGSVGElement, PropsWithChildren<SVGMotionProps<SVGSVGElement>>>((props, ref) => {
  ...
  return (
    <motion.svg layoutId='logo' ref={ref} initial="hidden" animate="visible" xmlns="http://www.w3.org/2000/svg" fill='#0466C8' viewBox="0 0 78.89 78.89" {...props}>
      <g transform="translate(0 12.35)">
